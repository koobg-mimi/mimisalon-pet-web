...
const InputComponent = React.forwardRef<HTMLInputElement, React.ComponentProps<'input'>>(
  ({ className, ...props }, ref) => (
    <Input
      className={cn('rounded-s-none rounded-e-md border-l-0 focus-visible:z-10', className)}
      {...props}
      ref={ref}
    />
  )
    ...
    >
      <PopoverTrigger asChild>
        <Button
          ...
          variant="outline"
          className={cn(
            'flex h-9 gap-1 rounded-s-md rounded-e-none border-r-0 bg-transparent px-3 focus:z-10',
