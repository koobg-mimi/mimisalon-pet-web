  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      if (method === 'email' && type === 'email-verification') {
        ...
        const result:
          | import('@/app/api/auth/verify-email-otp/route').VerifyEmailOtpResponse
          | import('@/app/api/auth/verify-email-otp/route').VerifyEmailOtpErrorResponse =
          await response.json()
        ...
        const result:
          | import('@/app/api/auth/verify-phone-otp/route').VerifyPhoneOtpResponse
          | import('@/app/api/auth/verify-phone-otp/route').VerifyPhoneOtpErrorResponse =
          await response.json()
