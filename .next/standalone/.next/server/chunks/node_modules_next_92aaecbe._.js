module.exports = [
      ...
      static wrap(e, r) {
        ...
        let n = [],
          ...
          c = () => {
            ...
            if (
              (e && (e.pathWasRevalidated = !0), (n = t.getAll().filter((e) => a.has(e.name))), r)
            ) {
              let e = []
              for (let r of n) {
                let t = new o.ResponseCookies(new Headers())
  ...
  (e, r, t) => {
    ...
    function p() {
      ...
      if (r) {
        ...
        if (r.forceStatic)
          return b(n.RequestCookiesAdapter.seal(new a.RequestCookies(new Headers({}))))
        ...
        if (t)
          switch (t.type) {
            case 'cache':
              ...
              throw (Error.captureStackTrace(o, p), (r.invalidDynamicUsageError ??= o), o)
            case 'unstable-cache':
              throw Object.defineProperty(
                Error(
            ...
            case 'prerender':
              ...
              let s = h.get(y)
              if (s) return s
              let g = (0, u.makeHangingPromise)(y.renderSignal, d.route, '`cookies()`')
              return (h.set(y, g), g)
            ...
            case 'prerender-runtime':
              return (0, i.delayUntilRuntimeStage)(t, b(t.cookies))
            case 'private-cache':
              return b(t.cookies)
            case 'request':
              return (
                (0, i.trackDynamicDataInDynamicRender)(t),
                b((0, n.areCookiesMutableInCurrentPhase)(t) ? t.userspaceMutableCookies : t.cookies)
              )
          }
      }
  ...
  (e, r, t) => {
    ...
    function f() {
      ...
      if (r) {
        if (t && 'after' === t.phase && !(0, d.isRequestAPICallableInsideAfter)())
          throw Object.defineProperty(
            Error(
        ...
        if (t)
          switch (t.type) {
            case 'cache': {
              ...
              throw (Error.captureStackTrace(e, f), (r.invalidDynamicUsageError ??= e), e)
            }
            case 'unstable-cache':
              throw Object.defineProperty(
                Error(
        ...
        if (t)
          switch (t.type) {
            case 'prerender':
              ...
              let a = p.get(b)
              if (a) return a
              let o = (0, c.makeHangingPromise)(b.renderSignal, u.route, '`headers()`')
              return (p.set(b, o), o)
            case 'prerender-client':
              let y = '`headers`'
              throw Object.defineProperty(
  ...
  (e, r, t) => {
    ...
    function d() {
      ...
      switch (((!e || !r) && (0, n.throwForMissingRequestStore)('draftMode'), r.type)) {
        case 'prerender-runtime':
        ...
        if (s)
          switch (s.type) {
            ...
            case 'private-cache': {
              ...
              throw (Error.captureStackTrace(n, r), (t.invalidDynamicUsageError ??= n), n)
            }
            case 'unstable-cache':
              throw Object.defineProperty(
                Error(
            ...
            case 'prerender-runtime': {
              ...
              return (0, o.abortAndThrowOnSynchronousRequestDataAccess)(t.route, e, r, s)
            }
            case 'prerender-client':
              let n = '`draftMode`'
              throw Object.defineProperty(
            ...
            case 'prerender-legacy':
              ...
              throw ((t.dynamicUsageDescription = e), (t.dynamicUsageStack = a.stack), a)
            case 'request':
  ...
  493458,
  (e, r, t) => {
    ;((r.exports.cookies = e.r(307460).cookies),
      (r.exports.headers = e.r(719971).headers),
      (r.exports.draftMode = e.r(721423).draftMode))
  },
]
