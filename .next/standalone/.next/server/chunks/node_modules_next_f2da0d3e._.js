module.exports = [
  ...
  (e, t, r) => {
    ...
    function o(e, t, r, o) {
      ...
      let a = e.toLowerCase()
      return !o &&
        ((0, n.pathHasPrefix)(a, '/api') || (0, n.pathHasPrefix)(a, `/${t.toLowerCase()}`))
        ? e
  ...
  (e, t, r) => {
    ...
    function a(e, t) {
      ...
      r &&
        ...
        ((u.pathname = (0, n.removePathPrefix)(u.pathname, r)), (u.basePath = r))
      let c = u.pathname
        ...
        ;((u.locale = e.detectedLocale),
          ...
          !e.detectedLocale &&
            ...
            (e = t.i18nProvider
              ...
              : (0, i.normalizeLocalePath)(c, a.locales)).detectedLocale &&
            (u.locale = e.detectedLocale))
      }
      return u
    }
    ...
    class l {
      constructor(e, t, r) {
        ...
        ;(('object' == typeof t && 'pathname' in t) || 'string' == typeof t
          ? ((i = t), (n = r || {}))
          : (n = r || t || {}),
          (this[c] = { url: u(e, i ?? n.base), options: n, basePath: '' }),
          this.analyze())
      }
      analyze() {
        var e, t, r, n, s
  ...
  (e, t, r) => {
    ...
    class l extends Request {
      constructor(e, t = {}) {
        ...
        this[c] = { cookies: new u.RequestCookies(this.headers), nextUrl: i, url: i.toString() }
      }
      [Symbol.for('edge-runtime.inspect.custom')]() {
        return {
        ...
        226: function (t, r) {
          !(function (i, n) {
            ...
            var o = 'function',
              ...
              W = function (e, t) {
                for (var r, i, n, a, u, c, l = 0; l < t.length && !u; ) {
                  var d = t[l],
                    h = t[l + 1]
                ...
                for (var r in t)
                  if (typeof t[r] === s && t[r].length > 0) {
                    for (var i = 0; i < t[r].length; i++)
                      if (B(t[r][i], e)) return '?' === r ? void 0 : r
                ...
                return (
                  (this.getBrowser = function () {
                    ...
                    return (
                      ...
                      (t[c] =
                        typeof (e = t[f]) === u ? e.replace(/[^\d\.]/g, '').split('.')[0] : void 0),
                      v && r && r.brave && typeof r.brave.isBrave == o && (t[d] = 'Brave'),
                      t
                    )
                  }),
                  ...
                  (this.getEngine = function () {
                    var e = {}
                    return ((e[d] = void 0), (e[f] = void 0), W.call(e, n, _.engine), e)
                  }),
                  (this.getOS = function () {
                    var e = {}
                    return (
                      ...
                      v &&
                        ...
                        m &&
                        'Unknown' != m.platform &&
                        (e[d] = m.platform.replace(/chrome os/i, H).replace(/macos/i, X)),
                      e
                    )
                  }),
  ...
  (e, t, r) => {
    ...
    let a = (i = e.r(399299)) && i.__esModule ? i : { default: i }
    function s(e) {
  ...
  (e, t, r) => {
    let i = {
      NextRequest: e.r(929666).NextRequest,
      NextResponse: e.r(546633).NextResponse,
      ImageResponse: e.r(887963).ImageResponse,
      userAgentFromString: e.r(504386).userAgentFromString,
      userAgent: e.r(504386).userAgent,
      URLPattern: e.r(779187).URLPattern,
      after: e.r(381053).after,
      connection: e.r(375674).connection,
    }
    ;((t.exports = i),
