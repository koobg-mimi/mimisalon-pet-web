      ...
      let [[t, r], ...s] = d(e),
        {
          ...
          partitioned: c,
          priority: f,
        } = Object.fromEntries(s.map(([e, t]) => [e.toLowerCase().replace(/-/g, ''), t]))
      {
        var x,
          g,
          y = {
            ...
            path: p,
            ...(l && { sameSite: m.includes((x = (x = l).toLowerCase())) ? x : void 0 }),
            ...(u && { secure: !0 }),
            ...(f && { priority: h.includes((g = (g = f).toLowerCase())) ? g : void 0 }),
            ...(c && { partitioned: !0 }),
          }
        let e = {}
    ...
    t.exports = ((e, t, r, a) => {
      if ((t && 'object' == typeof t) || 'function' == typeof t)
        for (let r of i(t))
          o.call(e, r) ||
            void 0 === r ||
            s(e, r, { get: () => t[r], enumerable: !(a = n(t, r)) || a.enumerable })
      return e
                  ...
                  for (t = a, i = !1; p(); )
                    if (',' === (r = e.charAt(a))) {
                      ...
                      a < e.length && '=' === e.charAt(a)
                        ? ((i = !0), (a = n), o.push(e.substring(t, s)), (t = a))
                        : (a = s + 1)
                    } else a += 1
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4bc656b1._.js.map
