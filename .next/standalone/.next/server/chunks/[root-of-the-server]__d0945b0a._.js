  ...
  (e) => {
    ...
    async function x() {
      try {
        ...
        return (
          console.error('Failed to fetch groomer stats:', e),
    ...
    let b = new t.AppRouteRouteModule({
        definition: {
          ...
          page: '/api/groomer/stats/route',
          pathname: '/api/groomer/stats',
          filename: 'route',
          bundlePath: '',
        },
        distDir: '.next',
        relativeProjectDir: '',
        resolvedPagePath: '[project]/src/app/api/groomer/stats/route.ts',
        nextConfigOutput: 'standalone',
        userland: C,
      }),
      { workAsyncStorage: y, workUnitAsyncStorage: A, serverHooks: k } = b
    function P() {
      return (0, a.patchFetch)({ workAsyncStorage: y, workUnitAsyncStorage: A })
    }
    async function N(e, t, a) {
      b.isDev && (0, n.addRequestMeta)(e, 'devRequestTimingInternalsEnd', process.hrtime.bigint())
      let g = '/api/groomer/stats/route'
      g = g.replace(/\/index$/, '') || '/'
      let E = await b.prepare(e, t, { srcPage: g, multiZoneDraftMode: !1 })
      if (!E)
        return (
          (t.statusCode = 400),
          t.end('Bad Request'),
      ...
      let {
        ...
        H = !!(k.dynamicRoutes[q] || k.routes[j]),
        M = async () => (
      ...
      let F = e.method || 'GET',
        ...
        B = {
          ...
          renderOpts: {
            ...
            onInstrumentationRequestError: (t, r, a) => b.onRequestError(e, t, a, P),
          },
          ...
          l = async (n) => {
            ...
            let u = async ({ previousCacheEntry: r }) => {
                try {
                  ...
                  if (!H)
                    return (await (0, h.sendResponse)(G, L, s, B.renderOpts.pendingWaitUntil), null)
                  {
                    let e = await s.blob(),
                      t = (0, v.toNodeOutgoingHttpHeaders)(s.headers)
                    ;(u && (t[_.NEXT_CACHE_TAGS_HEADER] = u),
            ...
            return (
              (i && H) || c.delete(_.NEXT_CACHE_TAGS_HEADER),
              !d.cacheControl ||
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d0945b0a._.js.map
