        ...
        } = Object.fromEntries(n.map(([e, r]) => [e.toLowerCase().replace(/-/g, ''), r]))
      {
        var l,
          ...
          R = {
            ...
            path: E,
            ...(a && { sameSite: p.includes((l = (l = a).toLowerCase())) ? l : void 0 }),
            ...(c && { secure: !0 }),
            ...(O && { priority: A.includes((I = (I = O).toLowerCase())) ? I : void 0 }),
            ...(L && { partitioned: !0 }),
          }
        let e = {}
    ...
    var p = ['strict', 'lax', 'none'],
      ...
      O = class {
        constructor(e) {
          ...
          if (r) for (const [e, t] of T(r)) this._parsed.set(e, { name: e, value: t })
        }
        [Symbol.iterator]() {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__96f31a1b._.js.map
