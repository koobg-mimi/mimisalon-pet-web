module.exports = [
  ...
  (e, t, r) => {
    ...
    let s = (n = e.r(347540)) && n.__esModule ? n : { default: n },
      c = e.r(865252),
      u = e.r(97573),
      l = e.r(832319),
      d = e.r(556704),
    ...
    function w(e, t, r) {
      let n = $(`Route ${e} needs to bail out of prerendering at this point because it used ${t}.`)
    ...
    function D(e) {
      e.stagedRendering && e.stagedRendering.advanceStage(y.RenderStage.Dynamic)
    }
    function j(e, t, r, n) {
      ...
      throw $(`Route ${e} needs to bail out of prerendering at this point because it used ${t}.`)
    }
    ...
    function T(e, t, r) {
      ;((function () {
        ...
        s.default.unstable_postpone(k(e, t)))
    }
    function k(e, t) {
...
${t}`
    ...
    function W() {
      ...
      return (
        e.abort(
          Object.defineProperty(new h.BailoutToCSRError('Render in Browser'), '__NEXT_ERROR_CODE', {
            value: 'E721',
            enumerable: !1,
            configurable: !0,
          })
      ...
      if (t && r)
        switch (r.type) {
          ...
          case 'prerender': {
            ...
            n && n.size > 0 && s.default.use((0, f.makeHangingPromise)(r.renderSignal, t.route, e))
            break
          }
          case 'prerender-ppr': {
            let n = r.fallbackRouteParams
    ...
    function q(e) {
      ...
      if (t)
        switch ((!r && (0, l.throwForMissingRequestStore)(e), r.type)) {
          case 'prerender-client':
            s.default.use((0, f.makeHangingPromise)(r.renderSignal, t.route, e))
            break
          case 'prerender-legacy':
          case 'prerender-ppr':
  ...
  - Rerun the production build with \`next build --debug-prerender\` to generate better stack traces.`)))
    ...
    function Z(e, t, r, n) {
      if (n.syncDynamicErrorWithStack)
        throw (Q(e, n.syncDynamicErrorWithStack), new u.StaticGenBailoutError())
      if (0 !== t) {
