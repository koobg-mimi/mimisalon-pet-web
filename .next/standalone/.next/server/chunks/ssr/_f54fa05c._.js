module.exports = [
  ...
  (a) => {
    ...
    a.s(['composeRefs', () => d, 'useComposedRefs', () => e], 470121)
    var f = a.i(187924)
    function g(a) {
      var c
      let e,
        g =
          ...
          ((e = b.forwardRef((a, c) => {
            ...
            if (b.isValidElement(e)) {
              ...
              return (e.type !== b.Fragment && (j.ref = c ? d(c, i) : i), b.cloneElement(e, j))
            }
        ...
        h = b.forwardRef((a, c) => {
          ...
          return (0, f.jsx)(g, { ...e, ref: c, children: d })
        })
    ...
    function j(a) {
      let b = ({ children: a }) => (0, f.jsx)(f.Fragment, { children: a })
    ...
    a.s(['Slot', () => h, 'createSlot', () => g, 'createSlottable', () => j], 811011)
  },
  368114,
  298621,
  (a) => {
...
//# sourceMappingURL=_f54fa05c._.js.map
