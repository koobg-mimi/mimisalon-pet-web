module.exports = [
  ...
  (a) => {
    'use strict'
    let b = (0, a.i(170106).default)('refresh-cw', [
  ...
  (a) => {
    ...
    var b = a.i(187924),
      ...
      e = a.i(669520),
      f = a.i(416025)
    function g({ error: a, reset: g }) {
      return (
        (0, c.useEffect)(() => {
          console.error('Global application error:', a)
        }, [a]),
        (0, b.jsx)('html', {
                    ...
                    (0, b.jsxs)('div', {
                      ...
                      children: [
                        (0, b.jsx)('div', {
                          ...
                          children: (0, b.jsx)('span', { className: 'text-4xl', children: '💥' }),
                        }),
                        (0, b.jsx)('h1', {
                    ...
                    (0, b.jsxs)('div', {
                      ...
                      children: [
                        (0, b.jsxs)(d.Button, {
                          ...
                          onClick: g,
                          children: [
                            (0, b.jsx)(e.RefreshCw, { className: 'mr-2 h-5 w-5' }),
                            '애플리케이션 재시작',
                          ],
                        }),
                        (0, b.jsx)(d.Button, {
                    ...
                    (0, b.jsx)('div', {
                      ...
                      children: (0, b.jsxs)('div', {
                        ...
                        children: [
                          (0, b.jsx)('p', {
                            children:
                              '이 오류는 자동으로 기록되었습니다. 계속 문제가 발생하면 고객센터로 문의해 주세요.',
                          }),
                          a.digest &&
                            (0, b.jsxs)('p', {
                              className: 'rounded bg-gray-100 p-2 font-mono text-xs',
                              children: ['오류 ID: ', a.digest],
                            }),
                          (0, b.jsxs)('div', {
                            className: 'flex flex-col justify-center gap-4 text-sm sm:flex-row',
                            children: [
                              (0, b.jsx)('span', { children: f.CUSTOMER_SERVICE.PHONE_DISPLAY }),
                              (0, b.jsx)('span', { children: f.CUSTOMER_SERVICE.EMAIL_DISPLAY }),
                            ],
                          }),
                        ],
                      }),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1f041765._.js.map
