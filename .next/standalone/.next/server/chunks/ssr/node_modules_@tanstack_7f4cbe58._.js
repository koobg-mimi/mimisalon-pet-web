module.exports = [
  ...
  (a) => {
    'use strict'
    let b, c, d, e, f, g
    var h = a.i(508361).systemSetTimeoutZero,
      i =
        ((b = []),
        (c = 0),
        (d = (a) => {
  ...
  (a) => {
    ...
    ;(a.s(['onlineManager', () => e], 312552), a.s(['pendingThenable', () => f], 479715))
          ...
          Promise.resolve(b)
            ...
            .catch((b) => {
              ...
              let c = a.retry ?? 3 * !d.isServer,
                ...
                h =
                  !0 === c || ('number' == typeof c && k < c) || ('function' == typeof c && c(k, b))
              j || !h
                ? p(b)
                : (k++,
                  a.onFail?.(k, b),
    ...
    a.s(['CancelledError', () => i, 'canFetch', () => h, 'createRetryer', () => j], 321778)
  },
  885659,
  (a) => {
    'use strict'
    var b = a.i(508361),
      ...
      d = class {
        ...
        scheduleGc() {
          ;(this.clearGcTimeout(),
            (0, c.isValidTimeout)(this.gcTime) &&
              (this.#g = b.timeoutManager.setTimeout(() => {
                this.optionalRemove()
              }, this.gcTime)))
        }
        updateGcTime(a) {
        ...
        clearGcTimeout() {
          this.#g && (b.timeoutManager.clearTimeout(this.#g), (this.#g = void 0))
        }
      }
    a.s(['Removable', () => d])
  },
      ...
      f = class extends e.Removable {
        ...
        setOptions(a) {
          if (
            ...
            void 0 !== a.data && (this.setState(h(a.data, a.dataUpdatedAt)), (this.#h = a))
          }
        }
        optionalRemove() {
        ...
        setData(a, c) {
          ...
          return (
            this.#o({ data: d, type: 'success', dataUpdatedAt: c?.updatedAt, manual: c?.manual }),
            d
          )
        }
        setState(a, b) {
          ...
          let f = new AbortController(),
            g = (a) => {
              Object.defineProperty(a, 'signal', {
                enumerable: !0,
                get: () => ((this.#n = !0), f.signal),
              })
            },
            h = () => {
              let a,
                d = (0, b.ensureQueryFn)(this.options, c),
                e = (g((a = { client: this.#k, queryKey: this.queryKey, meta: this.meta })), a)
