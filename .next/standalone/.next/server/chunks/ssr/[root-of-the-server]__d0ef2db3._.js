module.exports = [
  ...
  (a) => {
    ...
    var b = a.i(187924),
      ...
      l = a.i(238246)
    function m() {
      let { data: a, isPending: m } = (0, e.useSession)(),
        n = (0, f.useRouter)(),
        o = (0, f.useSearchParams)(),
        p = o.get('paymentId'),
        q = o.get('code'),
        r = o.get('message')
      ;(0, g.useEffect)(() => {
        if (q || r) {
          let a = r || '결제가 취소되었습니다',
            b = o.get('bookingId') || ''
          n.push(`/payment/fail?reason=${encodeURIComponent(a)}&bookingId=${b}`)
          return
        }
        ;(a || n.push('/auth/signin'),
          a?.user?.role && 'CUSTOMER' !== a.user.role && n.push('/dashboard'))
      }, [a, n, q, r, o])
      let { data: s, isLoading: t } = (0, h.useQuery)({
        queryKey: ['payment', p],
        queryFn: async ({ signal: a }) => {
          console.log('Verifying payment:', p)
          let b = await fetch(`/api/payments/verify/${p}`, { signal: a })
          if (!b.ok) {
            if (404 === b.status) throw Error('NOT_FOUND')
            throw Error('Failed to verify payment')
          }
          let c = await b.json()
          if (c.success && c.payment)
            return (console.log('Payment verification successful:', c), c.payment)
          if ('PENDING' === c.status || 'NOT_FOUND' === c.status) throw Error(c.status)
          {
            let a = c.error || c.message || '결제 확인 실패'
            throw (
              console.error('Payment verification failed:', a, c),
              n.push(`/payment/fail?reason=${encodeURIComponent(a)}&paymentId=${p}`),
              Error(a)
            )
          }
        },
        enabled: !!p && !!a?.user && 'CUSTOMER' === a.user.role && !q && !r,
        retry: (a, b) => ('PENDING' === b.message || 'NOT_FOUND' === b.message) && !!(a < 20),
        retryDelay: 3e3,
      })
      ;(0, g.useEffect)(() => {
        p || q || r || n.push('/customer/bookings')
      }, [p, q, r, n])
      let u = (0, i.useMutation)({
        mutationFn: async () => {
          let a = await fetch(`/api/payments/${p}/receipt`)
        ...
        onError: (a) => {
          console.error('Failed to download receipt:', a)
        },
      })
      return m || t || q || r
        ? (0, b.jsx)('div', {
            ...
            children: (0, b.jsxs)('div', {
              ...
              children: [
                (0, b.jsx)(k.LoadingSpinner, { size: 'lg' }),
                t &&
                  !q &&
                  !r &&
                  (0, b.jsxs)(b.Fragment, {
                    children: [
                      (0, b.jsx)('p', {
                        ...
                        children: '결제를 확인하고 있습니다...',
                      }),
                      (0, b.jsx)('p', {
                        className: 'text-muted-foreground mt-2 text-sm',
                        children: '최대 1분 정도 소요될 수 있습니다.',
                      }),
                    ],
                  }),
              ],
                  ...
                  children: [
                    (0, b.jsxs)('div', {
                      ...
                      children: [
                        (0, b.jsx)('div', {
                          className:
                            'mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-green-100',
                        ...
                        (0, b.jsxs)('div', {
                          ...
                          children: [
                            (0, b.jsx)('p', { children: '예약이 성공적으로 접수되었습니다.' }),
                            (0, b.jsx)('p', { children: '미용사 확인 후 예약이 확정됩니다.' }),
                          ],
                        }),
                      ],
                    }),
                          ...
                          children: [
                            (0, b.jsxs)('div', {
                              ...
                              children: [
                                ...
                                (0, b.jsx)('span', { className: 'font-medium', children: s.id }),
                              ],
                            }),
                            (0, b.jsxs)('div', {
                              className: 'flex items-center justify-between',
                              children: [
                                ...
                                (0, b.jsxs)('span', {
                                  ...
                                  children: [s.amount.toLocaleString('ko-KR'), '원'],
                                }),
                              ],
                            }),
                            s.booking &&
                              (0, b.jsxs)('div', {
                                ...
                                children: [
                                  ...
                                  (0, b.jsxs)('div', {
                                    ...
                                    children: [
                                      s.booking.pets &&
                                        s.booking.pets.length > 0 &&
                                        (0, b.jsx)(b.Fragment, {
                                          children: s.booking.pets.map((a, c) =>
                                            (0, b.jsxs)(
                                              'div',
                                              {
                                                className: 'space-y-2',
                                      ...
                                      s.booking.groomer &&
                                        (0, b.jsxs)('div', {
                                          ...
                                          children: [
                                            ...
                                            (0, b.jsx)('span', {
                                              children: s.booking.groomer.name,
                                            }),
                                          ],
                                        }),
                                      s.booking.address &&
                                        (0, b.jsxs)('div', {
                                          ...
                                          children: [
                                            ...
                                            (0, b.jsxs)('span', {
                                              children: [
                                                s.booking.address.street,
                                                ', ',
                                                s.booking.address.city,
                                              ],
                                            }),
                                          ],
                                        }),
                                      (s.booking.serviceDate || s.booking.serviceTime) &&
                                        (0, b.jsxs)('div', {
                                          className: 'flex justify-between',
                                          children: [
                                            (0, b.jsx)('span', {
                                            ...
                                            (0, b.jsxs)('span', {
                                              children: [
                                                s.booking.serviceDate &&
                                                  (0, c.format)(
                                                    new Date(s.booking.serviceDate),
                                                    'yyyy-MM-dd',
                                                    { locale: d.ko }
                                                  ),
                                                ' ',
                                                s.booking.serviceTime,
                                              ],
                                            }),
                                          ],
                                        }),
                            ...
                            s.booking?.id &&
                              (0, b.jsx)(j.Button, {
                                ...
                                children: (0, b.jsxs)(l.default, {
                                  href: `/customer/booking/${s.booking.id}`,
                                  children: [
                                    (0, b.jsx)('svg', {
                                      className: 'mr-2 h-4 w-4',
                                      fill: 'none',
                    ...
                    (0, b.jsxs)('div', {
                      ...
                      children: [
                        ...
                        (0, b.jsxs)('ul', {
                          className: 'space-y-1 text-left text-sm text-blue-800',
                          children: [
                            (0, b.jsx)('li', {
                              children: '• 예약 확정 여부는 SMS 또는 앱 알림으로 안내드립니다.',
                            }),
                            (0, b.jsx)('li', {
                              children: '• 예약 변경이나 취소는 예약일 1일 전까지 가능합니다.',
                            }),
                            (0, b.jsx)('li', {
                              children: '• 문의사항이 있으시면 고객센터로 연락주세요.',
                            }),
                            (0, b.jsx)('li', {
                              children: '• 서비스 완료 후 리뷰 작성시 포인트를 적립해드립니다.',
                            }),
                          ],
                        }),
                      ],
