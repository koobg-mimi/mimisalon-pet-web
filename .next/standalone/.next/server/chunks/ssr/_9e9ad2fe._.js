module.exports = [
  ...
  (a) => {
    ...
    var b = a.i(187924),
      ...
      v = a.i(858544)
    function w() {
      let a = (0, f.useQueryClient)(),
        [w, x] = (0, c.useState)(!1),
        [y, z] = (0, c.useState)(null),
        [A, B] = (0, c.useState)({
          name: '',
          description: '',
          price: '',
        ...
        }),
        {
          ...
          queryFn: async () => {
            let a = await fetch('/api/admin/service-options')
            if (!a.ok) throw Error('Failed to fetch service options')
            return a.json()
          },
        }),
        G = (0, e.useMutation)({
          mutationFn: async (a) => {
            let b = await fetch('/api/admin/service-options', {
              method: 'POST',
              ...
              body: JSON.stringify({
                ...
                applicableCategories: a.applicableCategories,
                displayOrder: parseInt(a.displayOrder),
                isActive: a.isActive,
              }),
            })
            if (!b.ok) throw Error((await b.json()).error || 'Failed to create option')
            return b.json()
          },
          onSuccess: () => {
            ;(a.invalidateQueries({ queryKey: ['admin', 'service-options'] }),
              u.toast.success('옵션 생성 완료', {
                description: '서비스 옵션이 성공적으로 생성되었습니다.',
              }),
              K())
          },
          onError: (a) => {
            u.toast.error('옵션 생성 실패', { description: a.message })
          },
        }),
        H = (0, e.useMutation)({
          mutationFn: async ({ id: a, data: b }) => {
            let c = await fetch(`/api/admin/service-options/${a}`, {
              method: 'PUT',
              headers: { 'Content-Type': 'application/json' },
              body: JSON.stringify({
                name: b.name,
                ...
                displayOrder: parseInt(b.displayOrder),
                isActive: b.isActive,
              }),
            })
            if (!c.ok) throw Error((await c.json()).error || 'Failed to update option')
            return c.json()
          },
          onSuccess: () => {
            ;(a.invalidateQueries({ queryKey: ['admin', 'service-options'] }),
              u.toast.success('옵션 수정 완료', {
                description: '서비스 옵션이 성공적으로 수정되었습니다.',
              }),
              K())
          },
          onError: (a) => {
            u.toast.error('옵션 수정 실패', { description: a.message })
          },
        }),
        I = (0, e.useMutation)({
          mutationFn: async (a) => {
            let b = await fetch(`/api/admin/service-options/${a}`, { method: 'DELETE' })
            if (!b.ok) throw Error((await b.json()).error || 'Failed to delete option')
            return b.json()
          },
          onSuccess: () => {
            ;(a.invalidateQueries({ queryKey: ['admin', 'service-options'] }),
              u.toast.success('옵션 삭제 완료', {
                description: '서비스 옵션이 성공적으로 삭제되었습니다.',
              }))
          },
          onError: (a) => {
            u.toast.error('옵션 삭제 실패', { description: a.message })
          },
        }),
        J = (a) => {
          ;(a
        ...
        L = (a) => {
          B((b) => ({
            ...b,
            applicableCategories: b.applicableCategories.includes(a)
              ? b.applicableCategories.filter((b) => b !== a)
              : [...b.applicableCategories, a],
          }))
        }
      return D
        ? (0, b.jsx)('div', {
            className: 'flex min-h-screen items-center justify-center',
            children: (0, b.jsx)(i.LoadingSpinner, {}),
          })
        : E
          ? (0, b.jsx)('div', {
              className: 'flex min-h-screen items-center justify-center',
              children: (0, b.jsxs)('div', {
                ...
                children: [
                  (0, b.jsx)(t.AlertCircle, { className: 'h-5 w-5' }),
                  (0, b.jsx)('p', {
                    children: F instanceof Error ? F.message : '옵션을 불러오는데 실패했습니다',
                  }),
                ],
              }),
            })
          : (0, b.jsxs)('div', {
              ...
              children: [
                    ...
                    (0, b.jsxs)('div', {
                      children: [
                        ...
                        (0, b.jsx)('p', {
                          ...
                          children: '반려동물 상태에 따른 추가 서비스 옵션을 관리합니다',
                        }),
                      ],
                    }),
                    (0, b.jsxs)(g.Button, {
                      onClick: () => J(),
                      children: [(0, b.jsx)(q.Plus, { className: 'mr-2 h-4 w-4' }), '옵션 추가'],
                    }),
                  ],
                }),
                (0, b.jsxs)(h.Card, {
                  children: [
                    (0, b.jsxs)(h.CardHeader, {
                      children: [
                        (0, b.jsx)(h.CardTitle, { children: '서비스 옵션 목록' }),
                        (0, b.jsxs)(h.CardDescription, {
                          children: ['총 ', C.length, '개의 옵션이 등록되어 있습니다'],
                        }),
                      ],
                    }),
                    (0, b.jsx)(h.CardContent, {
                      children: (0, b.jsxs)(j.Table, {
                        children: [
                          (0, b.jsx)(j.TableHeader, {
                            children: (0, b.jsxs)(j.TableRow, {
                              children: [
                                (0, b.jsx)(j.TableHead, { children: '옵션명' }),
                                (0, b.jsx)(j.TableHead, { children: '설명' }),
                                (0, b.jsx)(j.TableHead, { children: '가격' }),
                                (0, b.jsx)(j.TableHead, { children: '적용 카테고리' }),
                                (0, b.jsx)(j.TableHead, { children: '순서' }),
                                (0, b.jsx)(j.TableHead, { children: '상태' }),
                                (0, b.jsx)(j.TableHead, {
                          ...
                          (0, b.jsx)(j.TableBody, {
                            children:
                              0 === C.length
                                ? (0, b.jsx)(j.TableRow, {
                                    children: (0, b.jsx)(j.TableCell, {
                                      colSpan: 7,
                                      className: 'text-muted-foreground text-center',
                                      children: '등록된 옵션이 없습니다',
                                    }),
                                  })
                                : C.map((a) =>
                                    (0, b.jsxs)(
                                      j.TableRow,
                                      {
                                        children: [
                                          ...
                                          (0, b.jsxs)(j.TableCell, {
                                            children: [a.price.toLocaleString(), '원'],
                                          }),
                                          (0, b.jsx)(j.TableCell, {
                                            children: (0, b.jsx)('div', {
                                              className: 'flex flex-wrap gap-1',
                                              children: a.applicableCategories.map((a) =>
                                                (0, b.jsx)(
                                                  k.Badge,
                                                  {
                                                    variant: 'secondary',
                                                    children:
                                                      { ...v.DOG_CATEGORIES, ...v.CAT_CATEGORIES }[
                                                        a
                                                      ] || a,
                                                  },
                                                  a
                                          ...
                                          (0, b.jsx)(j.TableCell, { children: a.displayOrder }),
                                          (0, b.jsx)(j.TableCell, {
                                            children: (0, b.jsx)(k.Badge, {
                ...
                (0, b.jsx)(l.Dialog, {
                  open: w,
                  onOpenChange: x,
                  children: (0, b.jsxs)(l.DialogContent, {
                    className: 'max-w-2xl',
                    children: [
                      (0, b.jsxs)(l.DialogHeader, {
                        children: [
                          (0, b.jsx)(l.DialogTitle, { children: y ? '옵션 수정' : '옵션 추가' }),
                          (0, b.jsx)(l.DialogDescription, {
                            children:
                      ...
                      (0, b.jsxs)('form', {
                        onSubmit: (a) => {
                          ;(a.preventDefault(), y ? H.mutate({ id: y.id, data: A }) : G.mutate(A))
                        },
                        className: 'space-y-4',
                        children: [
                          (0, b.jsxs)('div', {
                            className: 'space-y-2',
                            children: [
                              (0, b.jsx)(n.Label, { htmlFor: 'name', children: '옵션명 *' }),
                              (0, b.jsx)(m.Input, {
                                id: 'name',
                                value: A.name,
                                onChange: (a) => B({ ...A, name: a.target.value }),
                          ...
                          (0, b.jsxs)('div', {
                            className: 'space-y-2',
                            children: [
                              (0, b.jsx)(n.Label, { htmlFor: 'description', children: '설명' }),
                              (0, b.jsx)(o.Textarea, {
                                id: 'description',
                                value: A.description,
                                onChange: (a) => B({ ...A, description: a.target.value }),
                              ...
                              (0, b.jsxs)('div', {
                                ...
                                children: [
                                  ...
                                  (0, b.jsx)(m.Input, {
                                    ...
                                    type: 'number',
                                    value: A.price,
                                    onChange: (a) => B({ ...A, price: a.target.value }),
                                    placeholder: '10000',
                                    min: '0',
                                    step: '1000',
                                    required: !0,
                              ...
                              (0, b.jsxs)('div', {
                                ...
                                children: [
                                  ...
                                  (0, b.jsx)(m.Input, {
                                    ...
                                    onChange: (a) => B({ ...A, displayOrder: a.target.value }),
                                    placeholder: '0',
                                    min: '0',
                                  }),
                                ],
                          ...
                          (0, b.jsxs)('div', {
                            className: 'space-y-2',
                            children: [
                              (0, b.jsx)(n.Label, { children: '적용 카테고리 *' }),
                              (0, b.jsxs)('div', {
                                className: 'space-y-4',
                                children: [
                                  (0, b.jsxs)('div', {
                                    children: [
                                      ...
                                      (0, b.jsx)('div', {
                                        ...
                                        children: Object.entries(v.DOG_CATEGORIES).map(([a, c]) =>
                                          (0, b.jsxs)(
                                            'div',
                                            {
                                              ...
                                              children: [
                                                (0, b.jsx)(p.Checkbox, {
                                                  id: `cat-${a}`,
                                                  checked: A.applicableCategories.includes(a),
                                                  onCheckedChange: () => L(a),
                                                }),
                                                (0, b.jsx)(n.Label, {
                                                  htmlFor: `cat-${a}`,
                                  ...
                                  (0, b.jsxs)('div', {
                                    children: [
                                      ...
                                      (0, b.jsx)('div', {
                                        className: 'grid grid-cols-2 gap-2',
                                        children: Object.entries(v.CAT_CATEGORIES).map(([a, c]) =>
                                          (0, b.jsxs)(
                                            'div',
                                            {
                                              className: 'flex items-center space-x-2',
                              ...
                              0 === A.applicableCategories.length &&
                                (0, b.jsx)('p', {
                                  className: 'text-destructive text-sm',
                                  children: '최소 1개 이상의 카테고리를 선택해주세요',
                                }),
                            ],
                          }),
                          (0, b.jsxs)('div', {
                            ...
                            children: [
                              (0, b.jsx)(p.Checkbox, {
                                id: 'isActive',
                                checked: A.isActive,
                                onCheckedChange: (a) => B({ ...A, isActive: a }),
                              }),
                              (0, b.jsx)(n.Label, {
                                htmlFor: 'isActive',
                                className: 'cursor-pointer',
                          ...
                          (0, b.jsxs)('div', {
                            ...
                            children: [
                              ...
                              (0, b.jsx)(g.Button, {
                                type: 'submit',
                                disabled:
                                  G.isPending || H.isPending || 0 === A.applicableCategories.length,
                                children: y ? '수정' : '생성',
                              }),
                            ],
                          }),
...
//# sourceMappingURL=_9e9ad2fe._.js.map
