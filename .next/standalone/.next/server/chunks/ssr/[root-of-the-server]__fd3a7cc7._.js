module.exports = [
  ...
  (a) => {
    ...
    var b = a.i(187924),
      ...
      g = a.i(205138)
    function h() {
      let { data: a, isPending: h } = (0, c.useSession)(),
        i = (0, d.useRouter)()
      if (
        ((0, e.useEffect)(() => {
          if (!a) return void i.push('/auth/signin')
          if (a?.user?.role) {
            let b = a.user.role
            'ADMIN' === b
              ? i.push('/admin/dashboard/overview')
              : 'GROOMER' === b
                ? i.push('/groomer/dashboard/overview')
                : 'CUSTOMER' === b && i.push('/customer/dashboard/overview')
          }
        }, [a, i]),
        h)
      )
      ...
      if (!a) return null
      let j = async () => {
        ;(await c.authClient.signOut(), i.push('/'))
      }
      return (0, b.jsxs)('div', {
                ...
                (0, b.jsxs)('div', {
                  ...
                  children: [
                    (0, b.jsxs)('span', {
                      ...
                      children: ['안녕하세요, ', a.user?.name, '님'],
                    }),
                    (0, b.jsx)(f.Button, { variant: 'outline', onClick: j, children: '로그아웃' }),
                  ],
                }),
              ],
            }),
                ...
                children: [
                  (0, b.jsxs)('div', {
                    ...
                    children: [
                      ...
                      (0, b.jsx)('p', {
                        ...
                        children: '등록된 반려동물을 관리하고 정보를 업데이트하세요.',
                      }),
                      (0, b.jsx)(f.Button, {
                        className: 'mt-4',
                        variant: 'outline',
                  ...
                  (0, b.jsxs)('div', {
                    ...
                    children: [
                      ...
                      (0, b.jsx)('p', {
                        className: 'text-muted-foreground',
                        children: '미용 예약을 확인하고 새로운 예약을 만들어보세요.',
                      }),
                      (0, b.jsx)(f.Button, {
                        className: 'mt-4',
                        variant: 'outline',
                  ...
                  (0, b.jsxs)('div', {
                    ...
                    children: [
                      ...
                      (0, b.jsx)('p', {
                        className: 'text-muted-foreground',
                        children: '지난 미용 서비스 이력과 리뷰를 확인하세요.',
                      }),
                      (0, b.jsx)(f.Button, {
                        className: 'mt-4',
                        variant: 'outline',
                  ...
                  a.user?.role === 'GROOMER' &&
                    (0, b.jsxs)('div', {
                      ...
                      children: [
                        ...
                        (0, b.jsx)('p', {
                          className: 'text-muted-foreground',
                          children: '고객 예약을 관리하고 스케줄을 확인하세요.',
                        }),
                        (0, b.jsx)(f.Button, {
                          className: 'mt-4',
                          variant: 'outline',
                  ...
                  a.user?.role === 'ADMIN' &&
                    (0, b.jsxs)('div', {
                      ...
                      children: [
                        ...
                        (0, b.jsx)('p', {
                          className: 'text-muted-foreground',
                          children: '시스템 관리 및 사용자 관리 기능에 접근하세요.',
                        }),
                        (0, b.jsx)(f.Button, {
                          className: 'mt-4',
                          variant: 'outline',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fd3a7cc7._.js.map
