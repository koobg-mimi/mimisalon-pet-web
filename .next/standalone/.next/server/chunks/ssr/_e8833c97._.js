  ...
  (a) => {
    ...
    let x = j.z.object({
      ...
      priceRanges: j.z
        .array(
          j.z.object({
            petType: j.z.enum(['DOG', 'CAT']),
            minWeight: j.z.number().min(0).nullable().optional(),
            maxWeight: j.z.number().nullable().optional(),
            price: j.z.number().min(1e3),
          })
        )
        .min(1, '최소 하나의 가격 설정이 필요합니다'),
      requirements: j.z.string().max(300, '요구사항은 최대 300자까지 입력 가능합니다').optional(),
      afterCareInstructions: j.z
        .string()
        .max(500, '애프터케어 안내는 최대 500자까지 입력 가능합니다')
        .optional(),
      isActive: j.z.boolean().optional().default(!0),
    })
    function y() {
      let { data: a, isPending: j } = (0, d.useSession)(),
        y = (0, e.useRouter)(),
        z = (0, g.useQueryClient)(),
        [A, B] = (0, c.useState)([]),
        C = (0, h.useForm)({
          resolver: (0, i.zodResolver)(x),
          defaultValues: {
            name: '',
            description: '',
            duration: '60',
        ...
        E = (0, f.useMutation)({
          mutationFn: async (a) => {
            let b = A.map((a) => ({
              ...
              d = await fetch('/api/admin/services', {
                method: 'POST',
            ...
            if (!d.ok)
              throw Error(
                (await d.json().catch(() => ({}))).error ||
                  `서비스 생성에 실패했습니다 (${d.status})`
              )
            return d.json()
          },
          onSuccess: () => {
            ;(z.invalidateQueries({ queryKey: ['admin', 'services'] }),
              alert('서비스가 성공적으로 생성되었습니다!'),
              y.push('/admin/dashboard/services'))
          },
          onError: (a) => {
            ;(console.error('Error creating service:', a),
      ...
      return j
        ? (0, b.jsx)('div', {
            ...
            children: (0, b.jsx)(s.LoadingSpinner, { size: 'lg' }),
          })
        : a
          ? a && a.user?.role === 'ADMIN'
            ? (0, b.jsxs)('div', {
                ...
                children: [
                  (0, b.jsxs)('div', {
                    ...
                    children: [
                      (0, b.jsxs)(p.Button, {
                        ...
                        onClick: () => y.back(),
                        children: [
                          (0, b.jsx)(k.ArrowLeft, { className: 'mr-2 h-4 w-4' }),
                          '뒤로가기',
                        ],
                      }),
                      (0, b.jsxs)('div', {
                        children: [
                          ...
                          (0, b.jsx)('p', {
                            ...
                            children: '미용 서비스의 상세 정보를 입력해주세요',
                          }),
                        ],
                      }),
                    ],
                  ...
                  (0, b.jsxs)(o.Card, {
                    children: [
                      (0, b.jsxs)(o.CardHeader, {
                        children: [
                          (0, b.jsx)(o.CardTitle, { children: '서비스 정보' }),
                          (0, b.jsx)(o.CardDescription, {
                            children: '반려동물 미용 서비스의 기본 정보를 설정합니다',
                          }),
                        ],
                      }),
                      (0, b.jsx)(o.CardContent, {
                        children: (0, b.jsx)(t.Form, {
                          ...C,
                          children: (0, b.jsxs)('form', {
                            onSubmit: C.handleSubmit((a) => {
                              E.mutate(a)
                            }),
                            className: 'space-y-6',
                            children: [
                                ...
                                render: ({ field: a }) =>
                                  (0, b.jsxs)(t.FormItem, {
                                    children: [
                                      ...
                                      (0, b.jsx)(t.FormDescription, { children: '30분 ~ 8시간' }),
                                      (0, b.jsx)(t.FormMessage, {}),
                                    ],
                                  }),
                              }),
                                      ...
                                      (0, b.jsxs)('div', {
                                        ...
                                        children: [
                                          ...
                                          (0, b.jsxs)(p.Button, {
                                            ...
                                            children: [
                                              (0, b.jsx)(m.PlusIcon, { className: 'mr-2 h-4 w-4' }),
                                              '가격 추가',
                                            ],
                                          }),
                                        ],
                                          ...
                                          (0, b.jsxs)(
                                            'div',
                                            {
                                              ...
                                              children: [
                                                ...
                                                (0, b.jsx)('div', {
                                                  children: (0, b.jsx)(w.BreedSelector, {
                                                    selectedBreedIds: a.selectedBreedIds || [],
                                                    onChange: (a) => {
                                                      let b = [...A]
                                                      ;((b[c].selectedBreedIds = a), D(b))
                                                    },
                                                    petType: a.petType,
                                                  }),
                                                }),
                                ...
                                children: [
                                  (0, b.jsxs)(o.CardHeader, {
                                    children: [
                                      ...
                                      (0, b.jsx)(o.CardDescription, {
                                        children: '서비스 요구사항과 애프터케어 안내를 입력하세요',
                                      }),
                                    ],
                                  }),
                                  (0, b.jsxs)(o.CardContent, {
                              ...
                              (0, b.jsxs)('div', {
                                ...
                                children: [
                                  ...
                                  (0, b.jsxs)(p.Button, {
                                    ...
                                    children: [
                                      E.isPending
                                        ? (0, b.jsx)(s.LoadingSpinner, {
                                            size: 'sm',
                                            className: 'mr-2',
                                          })
                                        : (0, b.jsx)(l.Save, { className: 'mr-2 h-4 w-4' }),
                                      '서비스 생성',
                                    ],
                                  }),
                                ],
            ...
            : (y.push('/admin/dashboard/overview'), null)
          : (y.push('/auth/signin'), null)
    }
    a.s(['default', () => y])
  },
]

//# sourceMappingURL=_e8833c97._.js.map
