module.exports = [
  ...
  (a) => {
    ...
    var b = a.i(187924),
      ...
      n = a.i(400187),
      o = a.i(368114)
    function p({ status: a, className: c = '' }) {
      return (0, b.jsx)('span', {
    ...
    let q = (0, n.cva)('rounded-lg border transition-all duration-300 overflow-hidden', {
        variants: {
          variant: {
            default:
      ...
      r = (0, n.cva)('flex items-start justify-between', {
        variants: { size: { sm: 'mb-3 gap-3', default: 'mb-4 gap-4', lg: 'mb-6 gap-6' } },
        defaultVariants: { size: 'default' },
      }),
      s = (0, n.cva)('font-semibold', {
        variants: { size: { sm: 'text-sm', default: 'text-base', lg: 'text-lg' } },
        defaultVariants: { size: 'default' },
      }),
      t = e.forwardRef(({ className: a, variant: c, size: d, payment: e, ...f }, h) => {
        var i
        let j = e.booking?.service?.name || e.orderName || '미용 서비스',
          n = e.booking?.pet?.name || ''
        return (0, b.jsxs)('div', {
          ref: h,
          className: (0, o.cn)(q({ variant: c, size: d, className: a })),
          ...f,
          children: [
            (0, b.jsxs)('div', {
              className: (0, o.cn)(r({ size: d })),
              children: [
                (0, b.jsxs)('div', {
                  className: 'min-w-0 flex-1',
                  children: [
                    (0, b.jsxs)('div', {
                      ...
                      children: [
                        (0, b.jsx)('h3', {
                          className: (0, o.cn)(s({ size: d }), 'truncate'),
                          children: j,
                        }),
                        (0, b.jsx)(p, { status: e.status }),
                      ],
                    }),
                    (0, b.jsxs)('p', {
                      ...
                      children: [
                        n && `${n} • `,
                        (i = e.method) && 'PENDING' !== i
                          ? i.includes('CARD') || i.includes('card')
                            ? '카드'
                            : i.includes('VIRTUAL_ACCOUNT') || i.includes('virtual')
                              ? '가상계좌'
                              : i.includes('TRANSFER') || i.includes('transfer')
                                ? '계좌이체'
                                : i.includes('KAKAO') || i.includes('kakao')
                                  ? '카카오페이'
                                  : i.includes('NAVER') || i.includes('naver')
                                    ? '네이버페이'
                                    : i.includes('TOSS') || i.includes('toss')
                                      ? '토스페이'
                                      : i.includes('PAYPAL') || i.includes('paypal')
                                        ? '페이팔'
                                        : i
                          : '처리중',
                      ],
                    ...
                    (0, b.jsx)('p', {
                      ...
                      children: (0, l.format)(new Date(e.createdAt), 'yyyy년 MM월 dd일 HH:mm', {
                        locale: m.ko,
                      }),
                    }),
                    e.booking &&
                      (0, b.jsxs)('p', {
                        ...
                        children: ['예약번호: ', e.booking.bookingNumber],
                      }),
                  ],
                }),
                (0, b.jsx)('div', {
                  ...
                  children: (0, b.jsxs)('p', {
                    ...
                    children: [e.amount.toLocaleString('ko-KR'), '원'],
                  }),
                }),
              ],
            }),
                ...
                e.booking
                  ? (0, b.jsx)(g.Button, {
                      ...
                      children: (0, b.jsx)(k.default, {
                        href: `/customer/booking/${e.booking.id}`,
                        children: '예약 상세',
                      }),
                    })
                  : (0, b.jsx)('div', {}),
                ('PAID' === e.status || 'COMPLETED' === e.status) &&
                  e.receiptUrl &&
                  (0, b.jsx)(g.Button, {
                    size: 'sm',
                    variant: 'outline',
    ...
    t.displayName = 'PaymentCard'
    let u = ['ALL', 'PAID', 'PENDING', 'FAILED', 'REFUNDED'],
      v = {
        ALL: null,
    ...
    function w({ activeFilter: a, onFilterChange: c }) {
      return (0, b.jsx)('div', {
        className: 'mb-6',
    ...
    function x({ filter: a }) {
      let { title: c, description: d } = (() => {
        switch (a) {
          ...
          case 'REFUNDED':
            return { title: '환불 내역이 없습니다', description: '환불 처리된 결제가 없습니다.' }
          default:
            return {
              title: '결제 내역이 없습니다',
      ...
      return (0, b.jsxs)('div', {
        ...
        children: [
          ...
          (0, b.jsx)('h3', { className: 'text-foreground mb-2 text-lg font-medium', children: c }),
          (0, b.jsx)('p', { className: 'text-muted-foreground mb-4', children: d }),
          'ALL' === a &&
            (0, b.jsx)(g.Button, {
              asChild: !0,
    ...
    function y() {
      let { data: a, isPending: l } = (0, c.useSession)(),
        ...
        [s, u] = (0, e.useState)(Number(n.get('limit')) || 10),
        y = (a, b, c) => {
      ...
      let { data: z, isLoading: A } = (0, f.useQuery)({
          queryKey: ['customer', 'payments', q, o, s],
          queryFn: async () => {
            ...
            let b = await fetch(`/api/customer/payments?${a.toString()}`)
            if (!b.ok) throw Error('Failed to fetch payments')
            return b.json()
          },
        ...
        B = z?.payments || [],
        C = z?.totalPages || 1
      return (B.filter((a) => 'PAID' === a.status || 'COMPLETED' === a.status).reduce(
        (a, b) => a + b.amount,
        0
      ),
      l || A)
              ...
              children: [
                (0, b.jsx)('header', {
                  ...
                  children: (0, b.jsx)(i.PageHeader, {
                    title: '결제 내역',
                    description: '미용 서비스 결제 내역과 영수증을 확인하세요',
                      ...
                      : (0, b.jsxs)('div', {
                          ...
                          children: [
                            (0, b.jsx)('div', {
                              ...
                              children: B.map((a) => (0, b.jsx)(t, { payment: a }, a.id)),
                            }),
                            C > 0 &&
                              (0, b.jsx)('div', {
                                className: 'mt-8',
    ...
    a.s(['default', () => y], 971161)
  },
]

//# sourceMappingURL=_743cdfec._.js.map
