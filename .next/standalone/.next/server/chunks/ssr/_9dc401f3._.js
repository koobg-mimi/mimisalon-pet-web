module.exports = [
  ...
  (a) => {
    ...
    var b = a.i(187924),
      ...
      t = a.i(571987)
    function u() {
      let { data: a, isPending: u } = (0, e.useSession)(),
        v = (0, f.useRouter)(),
        w = (0, j.useQueryClient)(),
        [x, y] = (0, g.useState)(!1)
      ;(0, g.useEffect)(() => {
        ;(a || v.push('/auth/signin'),
          a?.user?.role && 'ADMIN' !== a.user.role && v.push('/admin/dashboard/overview'))
      }, [a, v])
      let { data: z, isLoading: A } = (0, h.useQuery)({
          queryKey: ['admin', 'profile'],
          queryFn: async () => {
            let a = await fetch('/api/admin/profile')
        ...
        B = (0, i.useMutation)({
          mutationFn: async (a) => {
            let b = await fetch('/api/admin/profile', {
              method: 'PATCH',
          ...
          onSuccess: () => {
            ;(w.invalidateQueries({ queryKey: ['admin', 'profile'] }), y(!1))
          },
          onError: (a) => {
            console.error('Failed to update profile:', a)
          },
        }),
        C = (a) => (0, c.format)(new Date(a), 'yyyy-MM-dd', { locale: d.ko }),
        D = (a) => (0, c.format)(new Date(a), 'yyyy-MM-dd HH:mm:ss', { locale: d.ko })
      return u || A
        ? (0, b.jsx)('div', {
            className: 'flex min-h-screen items-center justify-center',
            children: (0, b.jsx)(s.LoadingSpinner, { size: 'lg' }),
          })
        : a && a.user?.role === 'ADMIN' && z
          ? (0, b.jsxs)('div', {
                      ...
                      children: (0, b.jsxs)('div', {
                        children: [
                          (0, b.jsxs)('div', {
                            ...
                            children: [
                              (0, b.jsx)(k.User, { className: 'text-primary h-6 w-6' }),
                              (0, b.jsx)('h1', {
                        ...
                        children: (0, b.jsx)('div', {
                          ...
                          children: (0, b.jsxs)('div', {
                            ...
                            children: [
                              (0, b.jsx)('div', {
                                className:
                                  'bg-primary/10 mx-auto mb-4 flex h-24 w-24 items-center justify-center rounded-full',
                                children: z.profileImage
                                  ? (0, b.jsx)(t.default, {
                                      src: z.profileImage,
                                      alt: z.name,
                                      className: 'h-24 w-24 rounded-full object-cover',
                                    })
                                  : (0, b.jsx)(l.Shield, { className: 'text-primary h-12 w-12' }),
                              }),
                              (0, b.jsx)('h2', {
                              ...
                              (0, b.jsxs)('div', {
                                ...
                                children: [
                                  (0, b.jsx)(l.Shield, { className: 'h-4 w-4 text-red-600' }),
                                  (0, b.jsx)('span', {
                              ...
                              (0, b.jsxs)('div', {
                                ...
                                children: [
                                  (0, b.jsxs)('div', {
                                    ...
                                    children: [
                                      (0, b.jsx)(o.Calendar, { className: 'h-4 w-4' }),
                                      (0, b.jsxs)('span', {
                                        children: ['가입일: ', C(z.createdAt)],
                                      }),
                                    ],
                                  }),
                                  z.lastLoginAt &&
                                    (0, b.jsxs)('div', {
                                      ...
                                      children: [
                                        (0, b.jsx)(o.Calendar, { className: 'h-4 w-4' }),
                                        (0, b.jsxs)('span', {
                                          children: ['최근 로그인: ', D(z.lastLoginAt)],
                                        }),
                                      ],
                                    }),
                                ],
                        ...
                        children: [
                          (0, b.jsxs)('div', {
                            ...
                            children: [
                              (0, b.jsxs)('div', {
                                className:
                                  'border-border flex items-center justify-between border-b p-6',
                                children: [
                                  (0, b.jsx)('h3', {
                              ...
                              x
                                ? (0, b.jsxs)('form', {
                                    onSubmit: (a) => {
                                      ...
                                      ;(a.preventDefault(),
                                        (c = {
                                          name: (b = new FormData(a.currentTarget)).get('name'),
                                        ...
                                        children: [
                                          ...
                                          (0, b.jsxs)('div', {
                                            children: [
                                              ...
                                              (0, b.jsx)('input', {
                                                ...
                                                disabled: !0,
                                                className:
                                                  'border-input bg-muted text-muted-foreground w-full rounded-md border px-3 py-2',
                                              }),
                                              (0, b.jsx)('p', {
                                          ...
                                          (0, b.jsxs)('div', {
                                            children: [
                                              ...
                                              (0, b.jsx)(r.PhoneInput, {
                                                name: 'phoneNumber',
                                                defaultCountry: 'KR',
                                                defaultValue: z.phoneNumber || '',
                                        ...
                                        children: [
                                          ...
                                          (0, b.jsxs)('div', {
                                            children: [
                                              ...
                                              (0, b.jsx)('p', {
                                                className: 'text-muted-foreground pl-6 text-sm',
                                                children: z.phoneNumber || '등록되지 않음',
                                              }),
                                            ],
                                          }),
                                          (0, b.jsxs)('div', {
                          ...
                          (0, b.jsxs)('div', {
                            className: 'border-border bg-card mt-6 rounded-lg border',
                            children: [
                              (0, b.jsx)('div', {
                                    ...
                                    (0, b.jsxs)('div', {
                                      children: [
                                        ...
                                        (0, b.jsx)('p', {
                                          className: 'text-muted-foreground pl-6 text-sm',
                                          children: (0, b.jsx)('span', {
                                            className: `rounded px-2 py-1 text-xs ${z.isActive ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`,
