  ...
  (a) => {
    ...
    var b = a.i(572131),
      ...
      g = class extends e.Subscribable {
        ...
        #z
        constructor(a, b) {
          ;(super(), (this.#a = a), this.setOptions(b), this.bindMethods(), this.#A())
        }
        bindMethods() {
        ...
        setOptions(a) {
          ...
          ;((this.options = this.#a.defaultMutationOptions(a)),
            (0, f.shallowEqualObjects)(this.options, b) ||
              this.#a
                .getMutationCache()
                .notify({ type: 'observerOptionsUpdated', mutation: this.#y, observer: this }),
            b?.mutationKey &&
            this.options.mutationKey &&
            (0, f.hashKey)(b.mutationKey) !== (0, f.hashKey)(this.options.mutationKey)
              ? this.reset()
              : this.#y?.state.status === 'pending' && this.#y.setOptions(this.options))
        }
        onUnsubscribe() {
        ...
        reset() {
          ;(this.#y?.removeObserver(this), (this.#y = void 0), this.#A(), this.#x())
        }
        mutate(a, b) {
          return (
            (this.#z = b),
        ...
        #A() {
          let a = this.#y?.state ?? (0, c.getDefaultState)()
          this.#f = {
            ...a,
        ...
        #x(a) {
          d.notifyManager.batch(() => {
            if (this.#z && this.hasListeners()) {
              ...
              a?.type === 'success'
                ? (this.#z.onSuccess?.(a.data, b, c, d), this.#z.onSettled?.(a.data, null, b, c, d))
                : a?.type === 'error' &&
                  (this.#z.onError?.(a.error, b, c, d),
                  this.#z.onSettled?.(void 0, a.error, b, c, d))
            }
            this.listeners.forEach((a) => {
              a(this.#f)
            })
...
//# sourceMappingURL=node_modules_%40tanstack_f25fe4b5._.js.map
