  ...
  (a) => {
    ...
    let c = Array(12).fill(0),
        ...
        constructor() {
          ;((this.subscribe = (a) => (
              ...
              let { message: c, ...e } = a,
                f =
                  ...
                  (null == (b = a.id) ? void 0 : b.length) > 0
                    ? a.id
                    : d++,
                g = this.toasts.find((a) => a.id === f),
                h = void 0 === a.dismissible || a.dismissible
              return (
                this.dismissedToasts.has(f) && this.dismissedToasts.delete(f),
                g
                  ? (this.toasts = this.toasts.map((b) =>
                      b.id === f
                        ? (this.publish({ ...b, ...a, id: f, title: c }),
                          { ...b, ...a, id: f, dismissible: h, title: c })
                        : b
                    ))
                  : this.addToast({ title: c, ...e, dismissible: h, id: f }),
                f
              )
            }),
            (this.dismiss = (a) => (
            ...
            (this.promise = (a, c) => {
              ...
              let g = Promise.resolve(a instanceof Function ? a() : a),
                h = void 0 !== e,
                i = g
                  .then(async (a) => {
                    if (((d = ['resolve', a]), b.default.isValidElement(a)))
                      ((h = !1), this.create({ id: e, type: 'default', message: a }))
                    else if (f(a) && !a.ok) {
                      h = !1
                      let d =
                        ...
                        f =
                          'function' == typeof c.description
                            ...
                            : c.description,
                        g = 'object' != typeof d || b.default.isValidElement(d) ? { message: d } : d
                      this.create({ id: e, type: 'error', description: f, ...g })
                      ...
                      let d = 'function' == typeof c.success ? await c.success(a) : c.success,
                        f =
                          'function' == typeof c.description
                            ...
                            : c.description,
                        g = 'object' != typeof d || b.default.isValidElement(d) ? { message: d } : d
                      this.create({ id: e, type: 'success', description: f, ...g })
                    }
                  })
                  .catch(async (a) => {
                  ...
                  .finally(() => {
                    ;(h && (this.dismiss(e), (e = void 0)), null == c.finally || c.finally.call(c))
                  }),
                j = () =>
                  new Promise((a, b) =>
                    i.then(() => ('reject' === d[0] ? b(d[1]) : a(d[1]))).catch(b)
                  )
              return 'string' != typeof e && 'number' != typeof e
                ? { unwrap: j }
                : Object.assign(e, { unwrap: j })
            }),
            (this.custom = (a, b) => {
              let c = (null == b ? void 0 : b.id) || d++
      ...
      g = Object.assign(
        (a, b) => {
          let c = (null == b ? void 0 : b.id) || d++
          return (e.addToast({ title: a, ...b, id: c }), c)
        },
        {
          success: e.success,
          info: e.info,
        ...
        { getHistory: () => e.toasts, getToasts: () => e.getActiveToasts() }
      )
    !(function (a) {
