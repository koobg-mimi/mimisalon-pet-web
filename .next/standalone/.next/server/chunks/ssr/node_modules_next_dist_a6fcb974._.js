module.exports = [
  ...
  (a) => {
    ...
    let { env: c, stdout: d } = (null == (b = globalThis) ? void 0 : b.process) ?? {},
      e =
        c &&
        !c.NO_COLOR &&
        (c.FORCE_COLOR || ((null == d ? void 0 : d.isTTY) && !c.CI && 'dumb' !== c.TERM)),
      f = (a, b, c, d) => {
    ...
    ;(new p(1e4, (a) => a.length),
      a.s(['error', () => t, 'warn', () => u, 'warnOnce', () => w], 943070))
  },
  717524,
  332885,
  (a) => {
    ...
    ;(a.s(
      ['DEFAULT_SEGMENT_KEY', 0, c, 'PAGE_SEGMENT_KEY', 0, '__PAGE__', 'isGroupSegment', () => b],
      332885
    ),
      a.s(['getComponentTypeModule', () => e, 'getLayoutOrPageModule', () => d], 717524))
  },
  662562,
  (a, b, c) => {
    ;(() => {
    ...
    let K = (a, b) => {
        ;('object' == typeof b && null !== b && b instanceof J && b.bubble
          ...
          : (b && (a.recordException(b), a.setAttribute('error.type', b.name)),
            a.setStatus({ code: G.ERROR, message: null == b ? void 0 : b.message })),
          a.end())
      },
      L = new Map(),
      ...
      P =
        ((c = new (class a {
          ...
          trace(...a) {
            ...
            let [c, d, e] = a,
              ...
              h = g.spanName ?? c
            if ((!B.includes(c) && '1' !== process.env.NEXT_OTEL_VERBOSE) || g.hideSpan) return f()
            let i = this.getSpanContext(
                (null == g ? void 0 : g.parentSpan) ?? this.getActiveScopeSpan()
              ),
              j = !1
            i
              ? (null == (b = F.getSpanContext(i)) ? void 0 : b.isRemote) && (j = !0)
        ...
        () => c)
    a.s(['SpanKind', () => H, 'SpanStatusCode', () => G, 'getTracer', () => P], 275164)
  },
  518702,
  (a) => {
    'use strict'
  ...
  (a) => {
    'use strict'
    ;(a.i(275164), a.i(118970), a.i(726026), a.i(368113))
    let b = {
      OPENING: {
    ...
    function c() {}
    ;(a.s(['ENCODED_TAGS', 0, b], 512213), a.i(891562))
  ...
  (a) => {
    ...
    ;(a.s(['removeTrailingSlash', () => b], 104108), a.s(['parsePath', () => c], 838549))
  },
  150376,
  292629,
  (a) => {
    ...
    ;(a.s(['addPathPrefix', () => c], 150376), a.s(['addPathSuffix', () => d], 292629))
  },
  183838,
  (a) => {
    'use strict'
  ...
  (a) => {
    ...
    ;(a.s(['formatNextPathnameInfo', () => f], 40475), a.s(['getHostname', () => g], 359168))
    let h = new WeakMap()
    function i(a, b) {
      let c
    ...
    a.s(['normalizeLocalePath', () => i], 871200)
  },
  7696,
  (a) => {
    'use strict'
  ...
  (a) => {
    ...
    ;(a.i(536226), Symbol('internal request'), Request, Symbol.for('edge-runtime.inspect.custom'))
    ...
    a.s(['isAbortError', () => t, 'pipeToNodeResponse', () => u], 414976)
  },
  971717,
  (a) => {
    'use strict'
  ...
  (a) => {
    'use strict'
    ;(a.i(200665), a.i(368113), a.i(200276))
    var b = a.i(22693),
      c = a.i(414976),
      d = a.i(585034)
    class e {
    ...
    ;(a.s(['default', () => e], 611614), a.i(403343), a.i(521751), a.s([], 675700))
  },
]
