module.exports = [
      ...
      k = c.forwardRef((a, k) => {
        ...
        return (
          !(function (a, b = globalThis?.document) {
            ...
            D === u.layers.size - 1 &&
              (o?.(a), !a.defaultPrevented && s && (a.preventDefault(), s()))
          }, x),
          c.useEffect(() => {
            if (v)
              return (
  ...
  (a) => {
    ...
    ;((s.displayName = 'Portal'), a.s(['Portal', () => s], 692616))
  },
  486228,
  (a) => {
    'use strict'
  ...
  (a) => {
    ...
    var k = ('function' == typeof SuppressedError && SuppressedError, a.i(572131)),
    ...
    var o = k.useEffect,
      ...
      s = k.forwardRef(function (a, b) {
        ...
        return k.createElement(
          ...
          s
            ? k.cloneElement(k.Children.only(t), i(i({}, H), { ref: G }))
            : k.createElement(void 0 === D ? 'div' : D, i({}, H, { className: u, ref: G }), t)
        )
      })
    ...
    var u = function () {
          ...
          add: function (c) {
            if (
              ...
              (b = (function () {
                ...
                a.type = 'text/css'
                var b = h || ('undefined' != typeof __webpack_nonce__ ? __webpack_nonce__ : void 0)
      ...
      F = function (a, b) {
        ...
        do {
          if (
            ('undefined' != typeof ShadowRoot && d instanceof ShadowRoot && (d = d.host), G(a, d))
          ) {
            var e = H(a, d)
            if (e[1] > e[2]) return !0
          }
      ...
      ((g = function (a) {
        ...
        return k.createElement(
          ...
          p
            ...
            : null,
          o ? k.createElement(D, { noRelative: a.noRelative, gapMode: a.gapMode }) : null
        )
      }),
      q.useMedium(g),
      t)
    ...
    ;((P.classNames = s.classNames), a.s(['RemoveScroll', 0, P], 152081))
  },
  241852,
  (a) => {
    'use strict'
        ...
        var j = (Array.isArray(a) ? a : [a])
          .map(function (a) {
            ...
            return b && g.contains(b)
              ? b
              : (console.error('aria-hidden', a, 'in not contained inside', g, '. Doing nothing'),
                null)
          })
          .filter(function (a) {
            return !!a
