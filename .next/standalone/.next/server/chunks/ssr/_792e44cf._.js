  ...
  (a) => {
    ...
    function v() {
      let a = (0, d.useSearchParams)(),
        ...
        D = (0, c.useRef)(null),
        E = (0, c.useRef)(null),
        { data: F, isLoading: G } = (0, e.useQuery)({
          queryKey: ['booking', w],
          queryFn: async () => {
            let a = await fetch(`/api/customer/booking/${w}`)
            if (!a.ok) throw Error('Failed to fetch booking')
            let b = await a.json()
            if ('SERVICE_COMPLETED' !== b.status)
              throw (v.push(`/customer/booking/${w}`), Error('Booking not completed'))
            return b
          },
          enabled: !!w,
          retry: !1,
        ...
        H = (0, f.useMutation)({
          mutationFn: async () => {
            let a = new FormData()
            ;(a.append('bookingId', w),
              a.append('rating', x.toString()),
              a.append('comment', z),
              B.forEach((b) => {
                a.append('images', b.file)
              }))
            let b = await fetch('/api/customer/reviews', { method: 'POST', body: a })
            if (!b.ok) throw Error((await b.json()).error || 'Failed to submit review')
            return b.json()
          },
          onSuccess: () => {
            v.push(`/customer/booking/${w}?reviewSubmitted=true`)
          },
          onError: (a) => {
            ;(console.error('Error submitting review:', a),
              alert('리뷰 등록에 실패했습니다. 다시 시도해주세요.'))
          },
        })
      if (!w) return (v.push('/customer/dashboard/overview'), null)
      let I = (a) => {
        if (!a) return
        let b = [],
          c = ['image/jpeg', 'image/jpg', 'image/png', 'image/webp', 'image/gif']
        ;(Array.from(a).forEach((a) => {
          if (!c.includes(a.type))
            return void alert(
              `${a.name}은(는) 지원하지 않는 파일 형식입니다. JPG, PNG, WEBP, GIF만 가능합니다.`
            )
          if (a.size > 5242880)
            return void alert(`${a.name}은(는) 파일 크기가 너무 큽니다. 5MB 이하만 가능합니다.`)
          if (B.length + b.length >= 5) return void alert('최대 5장까지만 업로드 가능합니다.')
          let d = URL.createObjectURL(a)
          b.push({ file: a, preview: d })
        }),
          C((a) => [...a, ...b]),
                ...
                children: [
                  (0, b.jsxs)('div', {
                    ...
                    children: [
                      (0, b.jsx)(i.Button, {
                        variant: 'ghost',
                        onClick: () => v.push(`/customer/booking/${w}`),
                        className: 'p-2',
                        children: (0, b.jsx)(s.ArrowLeftIcon, { className: 'h-5 w-5' }),
                      }),
                      (0, b.jsxs)('div', {
                        children: [
                          (0, b.jsx)('h1', {
                          ...
                          children: [
                            (0, b.jsxs)('div', {
                              ...
                              children: [
                                F.groomer.photoUrl
                                  ? (0, b.jsx)(g.default, {
                                      src: F.groomer.photoUrl,
                                      alt: F.groomer.name || '미용사',
                                      width: 48,
                                      height: 48,
                                ...
                                (0, b.jsxs)('div', {
                                  ...
                                  children: [
                                    (0, b.jsxs)('p', {
                                      ...
                                      children: [F.groomer.name, ' 미용사'],
                                    }),
                                    (0, b.jsx)('p', {
                                      className: 'text-muted-foreground text-sm',
                                      children: F.groomer.salon.name,
                                    }),
                                  ],
                                }),
                              ],
                            ...
                            (0, b.jsxs)('div', {
                              ...
                              children: [
                                (0, b.jsx)(r.CalendarIcon, {
                                  className: 'text-muted-foreground h-4 w-4',
                                }),
                                (0, b.jsxs)('span', {
                                  children: [F.appointmentDate, ' ', F.startTime],
                                }),
                              ],
                            }),
                            (0, b.jsxs)('div', {
                              className: 'flex items-center space-x-2 text-sm',
                              children: [
                                (0, b.jsx)(q.ScissorsIcon, {
                                  className: 'text-muted-foreground h-4 w-4',
                                }),
                                (0, b.jsx)('div', {
                                  className: 'flex flex-wrap gap-1',
                                  children: F.services.map((a) =>
                                    (0, b.jsx)(
                                      k.Badge,
                                      { variant: 'secondary', children: a.name },
                                      a.id
                                    )
                                  ),
                                }),
                            ...
                            (0, b.jsxs)('div', {
                              ...
                              children: [
                                ...
                                (0, b.jsxs)('span', {
                                  children: [F.pet.name, ' (', F.pet.breed, ')'],
                                }),
                              ],
                            }),
                          ],
                            ...
                            children: [1, 2, 3, 4, 5].map((a) =>
                              (0, b.jsx)(
                                'button',
                                {
                                  ...
                                  children: (0, b.jsx)(m.StarIcon, {
                                    className: `h-10 w-10 ${a <= x ? 'fill-yellow-400 text-yellow-400' : 'text-gray-300'} transition-colors hover:fill-yellow-400 hover:text-yellow-400`,
                                  }),
                                },
                                a
                              )
                  ...
                  (0, b.jsxs)(h.Card, {
                    children: [
                      (0, b.jsxs)(h.CardHeader, {
                        children: [
                          (0, b.jsx)(h.CardTitle, { className: 'text-lg', children: '상세 리뷰' }),
                          (0, b.jsx)(h.CardDescription, {
                            children: '어떤 점이 좋았나요? 개선점이 있다면 알려주세요.',
                          }),
                        ],
                      }),
                      (0, b.jsxs)(h.CardContent, {
                  ...
                  (0, b.jsxs)(h.Card, {
                    children: [
                      (0, b.jsxs)(h.CardHeader, {
                        children: [
                          (0, b.jsx)(h.CardTitle, { className: 'text-lg', children: '사진 첨부' }),
                          (0, b.jsx)(h.CardDescription, {
                            children: '미용 전후 사진을 공유해주세요 (최대 5장)',
                          }),
                        ],
                      }),
                      (0, b.jsxs)(h.CardContent, {
                                      ...
                                      (0, b.jsx)('button', {
                                        onClick: () => {
                                          C((a) => {
                                            let b = [...a]
                                            return (
                                              URL.revokeObjectURL(b[c].preview),
                                              b.splice(c, 1),
                                              b
                                            )
                                          })
                                        ...
                                        className:
                                          'absolute top-1 right-1 rounded-full bg-black/50 p-1 text-white transition-colors hover:bg-black/70',
                                        children: (0, b.jsx)(o.XIcon, { className: 'h-4 w-4' }),
                                      }),
                                    ],
                                  },
                                  c
                                ...
                                (0, b.jsxs)('div', {
                                  ...
                                  children: [
                                    (0, b.jsxs)(i.Button, {
                                      ...
                                      children: [
                                        (0, b.jsx)(u.FolderOpen, { className: 'mr-2 h-5 w-5' }),
                                        '사진 선택',
                                      ],
                                    }),
                                    (0, b.jsxs)(i.Button, {
                                      ...
                                      className: 'h-12 max-w-[160px] flex-1',
                                      children: [
                                        (0, b.jsx)(n.default, { className: 'mr-2 h-5 w-5' }),
                                        '카메라 촬영',
                                      ],
                                    }),
                                  ],
                  ...
                  (0, b.jsxs)('div', {
                    ...
                    children: [
                      ...
                      (0, b.jsx)(i.Button, {
                        ...
                        disabled: H.isPending || 0 === x || !z.trim(),
                        className: 'flex-1',
                        children: H.isPending
                          ...
                          : (0, b.jsxs)(b.Fragment, {
                              children: [
                                (0, b.jsx)(t.CheckCircleIcon, { className: 'mr-2 h-4 w-4' }),
                                '리뷰 등록',
                              ],
                            }),
                      }),
