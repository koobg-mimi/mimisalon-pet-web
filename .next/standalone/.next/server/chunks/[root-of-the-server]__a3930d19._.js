  ...
  (e) => {
      ...
      try {
        ...
        let { id: a } = await t,
          ...
          i = {
            ...
            isActive: s.isActive,
            petTypes: s.servicePetTypes.map((e) => e.petType),
            priceRanges: s.priceRanges,
            requirements: s.requiresVaccination ? '예방접종 필요' : void 0,
            afterCareInstructions: void 0,
            createdAt: s.createdAt.toISOString(),
            updatedAt: s.updatedAt.toISOString(),
            bookingCount: s._count.bookingServices,
            averageRating: 4.5,
          }
        return f.NextResponse.json(i)
      } catch (e) {
        return (
    ...
    let x = new t.AppRouteRouteModule({
        definition: {
          ...
          page: '/api/admin/services/[id]/toggle/route',
          pathname: '/api/admin/services/[id]/toggle',
          filename: 'route',
          bundlePath: '',
        },
        distDir: '.next',
        relativeProjectDir: '',
        resolvedPagePath: '[project]/src/app/api/admin/services/[id]/toggle/route.ts',
        nextConfigOutput: 'standalone',
        userland: A,
      }),
      { workAsyncStorage: y, workUnitAsyncStorage: P, serverHooks: T } = x
    function k() {
    ...
    async function S(e, t, a) {
      ...
      let f = '/api/admin/services/[id]/toggle/route'
      f = f.replace(/\/index$/, '') || '/'
      let E = await x.prepare(e, t, { srcPage: f, multiZoneDraftMode: !1 })
      if (!E)
        return (
          (t.statusCode = 400),
          t.end('Bad Request'),
      ...
      let {
        ...
        q = !!(P.dynamicRoutes[I] || P.routes[N]),
        H = async () => (
      ...
      let $ = e.method || 'GET',
        ...
        B = {
          ...
          renderOpts: {
            ...
            onInstrumentationRequestError: (t, r, a) => x.onRequestError(e, t, a, T),
          },
      ...
      try {
        let i = async (e) =>
          ...
          l = async (n) => {
            ...
            let d = async ({ previousCacheEntry: r }) => {
                try {
                    ...
                    return (await (0, h.sendResponse)(L, V, s, B.renderOpts.pendingWaitUntil), null)
                  {
                    ...
                    ;(d && (t[_.NEXT_CACHE_TAGS_HEADER] = d),
                      !t['content-type'] && e.type && (t['content-type'] = e.type))
                    let r =
                        void 0 !== B.renderOpts.collectedRevalidate &&
                        !(B.renderOpts.collectedRevalidate >= _.INFINITE_CACHE) &&
                        B.renderOpts.collectedRevalidate,
                      a =
                        void 0 === B.renderOpts.collectedExpire ||
                        B.renderOpts.collectedExpire >= _.INFINITE_CACHE
                          ? void 0
            ...
            return (
              (o && q) || c.delete(_.NEXT_CACHE_TAGS_HEADER),
              !u.cacheControl ||
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a3930d19._.js.map
