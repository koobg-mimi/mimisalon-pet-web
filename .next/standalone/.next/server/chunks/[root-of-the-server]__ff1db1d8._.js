module.exports = [
  254799,
  (e, o, t) => {
    o.exports = e.x('crypto', () => require('crypto'))
  },
  224361,
  (e, o, t) => {
    o.exports = e.x('util', () => require('util'))
  },
  814747,
  (e, o, t) => {
    o.exports = e.x('path', () => require('path'))
  },
  609730,
  438220,
  874321,
  ...
  (e) => {
    ...
    e.s(['getDefaultOptions', () => t], 662001)
    var r = e.i(609730)
    function n(e, t) {
      let n =
          t?.weekStartsOn ??
  ...
  (e) => {
    ...
    class o extends Error {
      constructor(e, o) {
        ;(super(e, o), (this.stack = Error(e, o).stack))
      }
    }
    e.s(['PortOneError', () => o])
  },
  992097,
  (e, o, t) => {
    o.exports = e.x('punycode', () => require('punycode'))
  },
  389579,
  (e) => {
    'use strict'
    var o = e.i(657446),
      t = e.i(647373)
    let r = new o.PrismaClient()
    class n {
      static isValidExpoPushToken(e) {
        return t.ExpoNotificationService.isValidExpoPushToken(e)
      }
      static async updateUserToken(e, o, n = 'android', i) {
        try {
          if (!t.ExpoNotificationService.isValidExpoPushToken(o))
      ...
      static async getUserTokens(e) {
        try {
          let o = await r.user.findUnique({
            where: { id: e },
            select: { notificationsEnabled: !0 },
          })
          if (!o || !o.notificationsEnabled) return []
          return (
            ...
            .filter((e) => t.ExpoNotificationService.isValidExpoPushToken(e.token))
            .map((e) => e.token)
        } catch (e) {
      ...
      static async updateNotificationPreference(e, o) {
        try {
          return (
            await r.user.update({ where: { id: e }, data: { notificationsEnabled: o } }),
            console.log(`Notification preference updated for user: ${e} to ${o}`),
            !0
          )
        } catch (e) {
  ...
  (e) => {
    ...
    class t {
      static async sendToDevice(e, t) {
        try {
          let r = {
            ...
            n = await o.ExpoNotificationService.sendToDevice(e, r)
      ...
      static async sendToMultipleDevices(e, t) {
        try {
          let r = {
              title: t.title,
              body: t.body,
            ...
            n = await o.ExpoNotificationService.sendToMultipleDevices(e, r)
          return (
  ...
  (e) => {
    ...
    class i {
      static async notifyNewBooking(e, i) {
        try {
          let s = await t.FCMTokenService.getUserToken(e)
          ...
          return await o.NotificationService.sendToDevice(s, u)
        } catch (e) {
      ...
      static async notifyGroomersNewBooking(e) {
        try {
          let i = await t.FCMTokenService.getTokensByRole('GROOMER')
          if (0 === i.length)
            return (
          ...
          return await o.NotificationService.sendToMultipleDevices(i, c)
        } catch (e) {
          return (
      ...
      static async notifyServiceStarted(e, r) {
        try {
          let n = await t.FCMTokenService.getUserToken(e)
          ...
          return await o.NotificationService.sendToDevice(n, s)
        } catch (e) {
      ...
      static async notifyPaymentStatus(e, r, n) {
        try {
          let i,
            s,
            a,
            c = await t.FCMTokenService.getUserToken(e)
          ...
          return await o.NotificationService.sendToDevice(c, u)
        } catch (e) {
      ...
      static async sendServiceReminder(e, i, s = 2) {
        try {
          let a = await t.FCMTokenService.getUserToken(e)
          ...
          return await o.NotificationService.sendToDevice(a, l)
        } catch (e) {
      ...
      static async sendTodayReminder(e, i) {
        try {
          ...
          return await o.NotificationService.sendToDevice(s, c)
        } catch (e) {
      ...
      static async notifyCustomerQuoteRequested(e, r) {
        try {
          ...
          return await o.NotificationService.sendToDevice(n, i)
        } catch (e) {
  ...
  (e) => {
    e.v((o) =>
      Promise.all(
        ['server/chunks/src_lib_portone-server_ts_7edfcdf0._.js'].map((o) => e.l(o))
      ).then(() => o(378725))
    )
  },
]

//# sourceMappingURL=%5Broot-of-the-server%5D__ff1db1d8._.js.map
